...
namespace NullD.Common.Versions
{
    /// <summary>
    ...
    public static class VersionInfo
    {
        ...
        public static class LogNet
        {
            ...
            /// </summary>
            public const int RequiredClientVersion = 11327; // 1.0.4
            ...
            public static Dictionary<LogNetClient.ClientPlatform, byte[]> PasswordHashMap = new Dictionary<LogNetClient.ClientPlatform, byte[]>()
            {
                { LogNetClient.ClientPlatform.Win,"8F52906A2C85B416A595702251570F96D3522F39237603115F2F1AB24962043C".ToByteArray() },
                { LogNetClient.ClientPlatform.Mac,"63BC118937E6EA2FAA7B7192676DAEB1B7CA87A9C24ED9F5ACD60E630B4DD7A4".ToByteArray() }
            };

            public static Dictionary<LogNetClient.ClientPlatform, byte[]> ThumbprintHashMap = new Dictionary<LogNetClient.ClientPlatform, byte[]>()
            {
                { LogNetClient.ClientPlatform.Win,"36b27cd911b33c61730a8b82c8b2495fd16e8024fc3b2dde08861c77a852941c".ToByteArray() },
                { LogNetClient.ClientPlatform.Mac,"36b27cd911b33c61730a8b82c8b2495fd16e8024fc3b2dde08861c77a852941c".ToByteArray() },
            };

            public static Dictionary<LogNetClient.ClientPlatform, byte[]> TokenHashMap = new Dictionary<LogNetClient.ClientPlatform, byte[]>()
            {
                { LogNetClient.ClientPlatform.Win,"bfa574bcff509b3c92f7c4b25b2dc2d1decb962209f8c9c8582ddf4f26aac176".ToByteArray() },
                { LogNetClient.ClientPlatform.Mac,"bfa574bcff509b3c92f7c4b25b2dc2d1decb962209f8c9c8582ddf4f26aac176".ToByteArray() },
            };

            public static Dictionary<LogNetClient.ClientPlatform, byte[]> RiskFingerprintHashMap = new Dictionary<LogNetClient.ClientPlatform, byte[]>()
            {
                { LogNetClient.ClientPlatform.Win,"bcfa324ab555fc66614976011d018d2be2b9dc23d0b54d94a3bd7d12472aa107".ToByteArray() },
                { LogNetClient.ClientPlatform.Mac,"bcfa324ab555fc66614976011d018d2be2b9dc23d0b54d94a3bd7d12472aa107".ToByteArray() },
            };

            public static Dictionary<LogNetClient.ClientPlatform, byte[]> AgreementHashMap = new Dictionary<LogNetClient.ClientPlatform, byte[]>()
            {
                { LogNetClient.ClientPlatform.Win,"41686a009b345b9cbe622ded9c669373950a2969411012a12f7eaac7ea9826ed".ToByteArray() },
                { LogNetClient.ClientPlatform.Mac,"41686a009b345b9cbe622ded9c669373950a2969411012a12f7eaac7ea9826ed".ToByteArray() },
            };
            ...
            public static class Achievements
            {
                ...
                /// </summary>
                public static string AchievementURL = "http://" + LogNet.Region + ".depot.battle.net:1119/" + AchievementFilename;
        ...
        public static class MPQ
        {
            ...
            /// </summary>
            public const int RequiredPatchVersion = 11327; //1.0.4
        }
        ...
        public static class Ingame
        {
            ...
            /// </summary>
            public const int ProtocolHash = unchecked((int)0xA3B7C936); // 1.0.4.11327

            /// <summary>
            /// Server version sent in VersionsMessage.
            /// </summary>
            public const string MajorVersion = "1.0.4"; // also 1.0.4
            public const string ServerBuild = "11327"; // also 11327
