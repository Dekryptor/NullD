...
using Config = NullD.Net.GS.Config;

namespace NullD.Core.LogNet.Games
{
    public class GameFactory : Channel
    {
        ...
        public void StartGame(List<LogNetClient> clients, ulong objectId)
        {
        ...
        public void JoinGame(List<LogNetClient> clients, ulong objectId)
        {
            foreach (var client in clients) // get all clients in game.
            {
                client.MapLocalObjectID(this.DynamicId, objectId); // map remote object-id.
        ...
        public bnet.protocol.game_master.ConnectInfo GetConnectionInfoForClient(LogNetClient client)
        {
