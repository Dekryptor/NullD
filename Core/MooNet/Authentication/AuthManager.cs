...
namespace NullD.Core.LogNet.Authentication
{
    public static class AuthManager
    {
        ...
        public static readonly Dictionary<LogNetClient, SRP6a> OngoingAuthentications = new Dictionary<LogNetClient, SRP6a>();

        public static void StartAuthentication(LogNetClient client, bnet.protocol.authentication.LogonRequest request)
        {
        ...
        public static void HandleAuthResponse(LogNetClient client, int moduleId, byte[] authMessage)
        {
