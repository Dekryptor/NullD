...
using NullD.Core.LogNet.Services;
using NullD.Net.LogNet;

namespace NullD.Core.LogNet.Commands
{
    [CommandGroup("services", "Lists LogNet services provided by the server.\nUsage: services [client]", Account.UserLevels.Owner)]
    public class ServiceDebugCommands : CommandGroup
    {
        [DefaultCommand]
        public string Services(string[] @params, LogNetClient invokerClient)
        {
        ...
        public string ClientServices(string[] @params, LogNetClient invokerClient)
        {
    ...
    public class HashDebugCommands : CommandGroup
    {
        ...
        public string HashItem(string[] @params, LogNetClient invokerClient)
        {
            if (@params.Count() < 1)
    ...
    public class RPCObjectDebugCommands : CommandGroup
    {
        ...
        public string List(string[] @params, LogNetClient invokerClient)
        {
