...
namespace NullD.Core.LogNet.Commands
{
    public static class CommandManager
    {
        ...
        public static bool TryParse(string line, LogNetClient invokerClient)
        {
            string output = string.Empty;
            string command;
            string parameters;
        ...
        {
            public override string Fallback(string[] parameters = null, LogNetClient invokerClient = null)
            {
        ...
        public class HelpCommandGroup : CommandGroup
        {
            ...
            public override string Handle(string parameters, LogNetClient invokerClient = null)
            {
