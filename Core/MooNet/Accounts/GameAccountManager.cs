...
namespace NullD.Core.LogNet.Accounts
{
            ...
            var newDBGameAccount = new DBGameAccount
                                       {
                                           ...
                                           StashSize = NullD.Net.GS.Config.Instance.StarterStash, // Stash size when you create a game account. [Necrosummon]
                                           Gold = NullD.Net.GS.Config.Instance.StarterGold // Starter gold when you create a game account. [Necrosummon]
                                       };
