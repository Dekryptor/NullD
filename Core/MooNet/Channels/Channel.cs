...
namespace NullD.Core.LogNet.Channels
{
    public class Channel : RPCObject
    {
        ...
        /// </summary>
        public readonly Dictionary<LogNetClient, Member> Members = new Dictionary<LogNetClient, Member>();
        ...
        /// Channel owner.
        /// </summary>
        public LogNetClient Owner { get; protected set; }
        ...
        public Channel(LogNetClient client, bool isGameChannel = false, ulong remoteObjectId = 0)
        {
        ...
        public bool HasUser(LogNetClient client)
        {
        ...
        public Member GetMember(LogNetClient client)
        {
        ...
        public void SetOwner(LogNetClient client)
        {
        ...
        public void Join(LogNetClient client, ulong remoteObjectId)
        {
        ...
        public void RemoveMember(LogNetClient client, RemoveReason reason)
        {
            RemoveMember(client, reason, false);
        }
