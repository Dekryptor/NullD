...
namespace NullD.Core.LogNet.Channels
{
    ...
    {
        [DefaultCommand]
        public string Channels(string[] @params, LogNetClient invokerClient)
        {
        ...
        public string ChannelState(string[] @params, LogNetClient invokerClient)
        {
            if (@params.Count() < 1)
        ...
        public string ChannelList(string[] @params, LogNetClient invokerClient)
        {
        ...
        public string ClientChannels(string[] @params, LogNetClient invokerClient)
        {
