...
namespace NullD.Core.LogNet.Objects
{
    /// <summary>
    ...
    public class RPCObject
    {
        ...
        /// </summary>
        public List<LogNetClient> Subscribers { get; private set; }
        ...
        protected RPCObject()
        {
            ...
            this.Subscribers = new List<LogNetClient>();
        }
        ...
        public void RemoveSubscriber(LogNetClient client)
        {
        ...
        /// </summary>
        public NullD.Core.LogNet.Helpers.FieldKeyHelper ChangedFields = new NullD.Core.LogNet.Helpers.FieldKeyHelper();
        ...
        public void UpdateSubscribers(List<LogNetClient> subscribers, List<bnet.protocol.presence.FieldOperation> operations)
        {
            var disconnected = new List<LogNetClient>();
            foreach (var subscriber in this.Subscribers)
            {
