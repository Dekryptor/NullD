...
namespace NullD.Core.LogNet.Web
{
    /// <summary>
    /// Web service that can return statistics on online players and so.
    /// </summary>
    [ServiceContract(Name = "LogNet")]
    public class LogNetWebService : IWebService
    {
        /// <summary>
        /// Always returns true, so that clients can see if the LogNet-server is online.
        /// </summary>
