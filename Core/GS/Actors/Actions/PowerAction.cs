...
namespace NullD.Core.GS.Actors.Actions
{
                ...
                else
                {
                    ...
                    if (_pathUpdateTimer == null || _pathUpdateTimer.TimedOut)
                    {
                        ...
                        if (this.Owner.AnimationSet == null)
                            aniTag = -1;
                        else if (this.Owner.AnimationSet.TagExists(NullD.Common.MPQ.FileFormats.AnimationTags.Walk))
                            aniTag = this.Owner.AnimationSet.GetAnimationTag(NullD.Common.MPQ.FileFormats.AnimationTags.Walk);
                        else if (this.Owner.AnimationSet.TagExists(NullD.Common.MPQ.FileFormats.AnimationTags.Run))
                            aniTag = this.Owner.AnimationSet.GetAnimationTag(NullD.Common.MPQ.FileFormats.AnimationTags.Run);
                        else
                            aniTag = -1;
