...
using NullD.Core.GS.Common.Types.Misc;
...
namespace NullD.Core.GS.Actors
{
    public abstract class Actor : WorldObject
    {
        ...
        /// </summary>
        public NullD.Common.MPQ.FileFormats.QuestRange _questRange;

        protected NullD.Common.MPQ.FileFormats.ConversationList ConversationList;
        ...
        /// </summary>
        public NullD.Common.MPQ.FileFormats.Actor ActorData { get; private set; }

        /// <summary>
        /// The animation set for actor.
        /// </summary>
        public NullD.Common.MPQ.FileFormats.AnimSet AnimationSet { get; private set; }
            ...
            : base(world, world.NewActorID)
        {
            ...
            this.ActorData = (NullD.Common.MPQ.FileFormats.Actor)NullD.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.Actor][snoId].Data;
            if (this.ActorData.AnimSetSNO != -1)
                this.AnimationSet = (NullD.Common.MPQ.FileFormats.AnimSet)NullD.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.AnimSet][this.ActorData.AnimSetSNO].Data;
        ...
        public override bool Reveal(Player player)
        {
            ...
            if (this is Door || this is DoorProximity)
            {
                if (this.Attributes[GameAttribute.Gizmo_State] == 1)
                {
                    this.World.BroadcastIfRevealed(new SetIdleAnimationMessage
                    {
                        ActorID = this.DynamicID,
        ...
        public virtual void OnTargeted(Player player, NullD.Net.GS.Message.Definitions.World.TargetMessage message)
        {
        ...
        protected virtual void ReadTags()
        {
            ...
            if (Tags.ContainsKey(MarkerKeys.QuestRange))
            {
                ...
                if (NullD.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.QuestRange].ContainsKey(snoQuestRange))
                    _questRange = NullD.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.QuestRange][snoQuestRange].Data as NullD.Common.MPQ.FileFormats.QuestRange;
            ...
            if (Tags.ContainsKey(MarkerKeys.ConversationList))
            {
                ...
                if (NullD.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.ConversationList].ContainsKey(snoConversationList))
                    ConversationList = NullD.Common.MPQ.MPQStorage.Data.Assets[SNOGroup.ConversationList][snoConversationList].Data as NullD.Common.MPQ.FileFormats.ConversationList;
                else
                {
        ...
        public void Move(Vector3D point, float facingAngle)
        {
            ...
            if (this.AnimationSet == null)
                aniTag = -1;
            else if (this.AnimationSet.TagExists(NullD.Common.MPQ.FileFormats.AnimationTags.Walk))
                aniTag = this.AnimationSet.GetAnimationTag(NullD.Common.MPQ.FileFormats.AnimationTags.Walk);
            else if (this.AnimationSet.TagExists(NullD.Common.MPQ.FileFormats.AnimationTags.Run))
                aniTag = this.AnimationSet.GetAnimationTag(NullD.Common.MPQ.FileFormats.AnimationTags.Run);
            else
                aniTag = -1;
