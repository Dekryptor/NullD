...
using System.Text;
using Monster = NullD.Core.GS.Actors.Monster;
...
namespace NullD.Core.GS.Games
{
    ...
    {
        [DefaultCommand]
        public string Spawn(string[] @params, LogNetClient invokerClient)
        {
            if (invokerClient == null)
                return "You can not invoke this command from console.";
    ...
    {
        [DefaultCommand]
        public string Coords(string[] @params, LogNetClient invokerClient)
        {
            if (invokerClient == null)
                return "You can not invoke this command from console.";
    ...
    public class ItemCommand : CommandGroup
    {
        ...
        public string Type(string[] @params, LogNetClient invokerClient)
        {
            if (invokerClient == null)
                return "You can not invoke this command from console.";
    ...
    {
        [DefaultCommand]
        public string Quest(string[] @params, LogNetClient invokerClient)
        {
            if (invokerClient == null)
                return "You can not invoke this command from console.";
        ...
        public string Advance(string[] @params, LogNetClient invokerClient)
        {
            if (@params == null)
                return this.Fallback();
        ...
        public string Trigger(string[] @params, LogNetClient invokerClient)
        {
            if (@params == null)
                return this.Fallback();
            ...
            invokerClient.InGameClient.Game.Quests.Notify((NullD.Common.MPQ.FileFormats.QuestStepObjectiveType)Int32.Parse(@params[0]), Int32.Parse(@params[1]));
            return "Triggered";
        }

        [Command("triggers", "lists all current quest triggers")]
        public string Triggers(string[] @params, LogNetClient invokerClient)
        {
    ...
    public class LookupCommand : CommandGroup
    {
        ...
        public string Actor(string[] @params, LogNetClient invokerClient)
        {
            var matches = new List<Asset>();
        ...
        public string Monster(string[] @params, LogNetClient invokerClient)
        {
            var matches = new List<Asset>();
        ...
        public string Power(string[] @params, LogNetClient invokerClient)
        {
            var matches = new List<Asset>();
        ...
        public string World(string[] @params, LogNetClient invokerClient)
        {
            var matches = new List<Asset>();
        ...
        public string Scene(string[] @params, LogNetClient invokerClient)
        {
            var matches = new List<Asset>();
        ...
        {
            [DefaultCommand]
            public string Save(string[] @params, LogNetClient invokerClient)
            {
                if (invokerClient == null)
                    return "You can not invoke this command from console.";
        ...
        {
            [DefaultCommand]
            public string ChangeName(string[] @params, LogNetClient invokerClient)
            {
                if (invokerClient == null)
                    return "You can not invoke this command from console.";
        ...
        {
            [DefaultCommand]
            public string ModifySpeed(string[] @params, LogNetClient invokerClient)
            {
                if (invokerClient == null)
                    return "You can not invoke this command from console.";
                ...
                {
                    playerSpeed[NullD.Net.GS.Message.GameAttribute.Running_Rate] = BaseSpeed;
                    return "Speed changed to Base Speed";
                }

                if (SpeedValue > MaxSpeed)
                {
                    playerSpeed[NullD.Net.GS.Message.GameAttribute.Running_Rate] = MaxSpeed;
                    return string.Format("MaxSpeed {0}", MaxSpeed);
                }
                else
                    playerSpeed[NullD.Net.GS.Message.GameAttribute.Running_Rate] = SpeedValue;
        ...
        {
            [DefaultCommand]
            public string ModifyScale(string[] @params, LogNetClient invokerClient)
            {
                if (invokerClient == null)
                    return "You can not invoke this command from console.";
