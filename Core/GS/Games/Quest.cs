...
using System.Linq;
using NullD.Net.GS.Message.Definitions.Quest;
...
namespace NullD.Core.GS.Games
{
    ...
    {
        void Notify(NullD.Common.MPQ.FileFormats.QuestStepObjectiveType type, int value);
        void NotifyBonus(NullD.Common.MPQ.FileFormats.QuestStepObjectiveType type, int value);
    }
    ...
    public class Quest : QuestProgressHandler
    {
        ...
        public class QuestStep : QuestProgressHandler
        {
            ...
            public class QuestObjective : QuestProgressHandler
            {
                ...
                public NullD.Common.MPQ.FileFormats.QuestStepObjectiveType ObjectiveType { get { return objective.ObjectiveType; } }
                public int ObjectiveValue { get { return objective.SNOName1.Id; } }

                private NullD.Common.MPQ.FileFormats.QuestStepObjective objective;
                ...
                public void NotifyBonus(NullD.Common.MPQ.FileFormats.QuestStepObjectiveType type, int value)
                {
                    ...
                    switch (type)
                    {
                        ...
                        case NullD.Common.MPQ.FileFormats.QuestStepObjectiveType.BonusStep:
                            {
                                Counter++;
                        ...
                        case NullD.Common.MPQ.FileFormats.QuestStepObjectiveType.EnterLevelArea:
                        case NullD.Common.MPQ.FileFormats.QuestStepObjectiveType.EnterTrigger:
                        case NullD.Common.MPQ.FileFormats.QuestStepObjectiveType.EventReceived:
                        case NullD.Common.MPQ.FileFormats.QuestStepObjectiveType.GameFlagSet:
                        case NullD.Common.MPQ.FileFormats.QuestStepObjectiveType.KillGroup:
                        case NullD.Common.MPQ.FileFormats.QuestStepObjectiveType.PlayerFlagSet:
                        case NullD.Common.MPQ.FileFormats.QuestStepObjectiveType.PossessItem:
                ...
                /// </summary>
                public void Notify(NullD.Common.MPQ.FileFormats.QuestStepObjectiveType type, int value)
                {
            ...
            private NullD.Common.MPQ.FileFormats.IQuestStep _questStep = null;
            ...
            {
                Logger.Debug(" (UpdateCounter) is _questStep unassiagned ? {0}", (_questStep is NullD.Common.MPQ.FileFormats.QuestUnassignedStep == false));
                if (_questStep is NullD.Common.MPQ.FileFormats.QuestUnassignedStep == false)
                {
            ...
            public QuestStep(NullD.Common.MPQ.FileFormats.IQuestStep assetQuestStep, Quest quest)
            {
                ...
                if (assetQuestStep is NullD.Common.MPQ.FileFormats.QuestStep)
                {
                    var step = assetQuestStep as NullD.Common.MPQ.FileFormats.QuestStep;
        ...
        public class QuestCompletionStep
        {
            ...
            public QuestCompletionStep(NullD.Common.MPQ.FileFormats.QuestCompletionStep QCSasset)
            {
        ...
        private NullD.Common.MPQ.FileFormats.Quest asset = null;
        ...
        public Quest(Game game, int SNOQuest)
        {
            ...
            asset = SNOHandle.Target as NullD.Common.MPQ.FileFormats.Quest;
