...
namespace NullD.Core.GS.Games
{
    ...
    public class GameDebugCommands : CommandGroup
    {
        ...
        //    public string Position(string[] @params, LogNetClient invokerClient)
        //    {
        //        Player player;
        ...
        //    public string Revealed(string[] @params, LogNetClient invokerClient)
        //    {
        //        Player player;
        ...
        //    public string InRange(string[] @params, LogNetClient invokerClient)
        //    {
        //        Player player;
        ...
        {
            [DefaultCommand]
            public string DrawWorld(string[] @params, LogNetClient invokerClient)
            {
