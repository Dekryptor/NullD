...
using NullD.Core.GS.Common.Types.Collision;
...
using NullD.Net.GS.Message.Definitions.Scene;
...
namespace NullD.Core.GS.Map
{
    ...
    public sealed class Scene : WorldObject
    {
        ...
        /// </summary>
        public NullD.Common.MPQ.FileFormats.Scene.NavMeshDef NavMesh { get; private set; }
        ...
        private void LoadSceneData()
        {
            ...
            var data = MPQStorage.Data.Assets[SNOGroup.Scene][this.SceneSNO.Id].Data as NullD.Common.MPQ.FileFormats.Scene;
            if (data == null) return;
        ...
        public void LoadMarkers()
        {
            ...
            {
                var markerSetData = MPQStorage.Data.Assets[SNOGroup.MarkerSet][markerSet].Data as NullD.Common.MPQ.FileFormats.MarkerSet;
                ...
                foreach (var marker in markerSetData.Markers)
                {
                    switch (marker.Type)
                    {
                        case NullD.Common.MPQ.FileFormats.MarkerType.AmbientSound:
                        case NullD.Common.MPQ.FileFormats.MarkerType.Light:
                        case NullD.Common.MPQ.FileFormats.MarkerType.Particle:
                        case NullD.Common.MPQ.FileFormats.MarkerType.SubScenePosition:
                        case NullD.Common.MPQ.FileFormats.MarkerType.AudioVolume:
                            // nothing to do for these here, client load them on its own
                            break;

                        case NullD.Common.MPQ.FileFormats.MarkerType.Script:
                        ...
                        case NullD.Common.MPQ.FileFormats.MarkerType.Event:
                        ...
                        case NullD.Common.MPQ.FileFormats.MarkerType.MinimapMarker:
                        ...
                        case NullD.Common.MPQ.FileFormats.MarkerType.Actor:
                        ...
                        case NullD.Common.MPQ.FileFormats.MarkerType.Encounter:

                            var encounter = marker.SNOHandle.Target as NullD.Common.MPQ.FileFormats.Encounter;
                        ...
                        default:
                            ...
                            if ((int)marker.Type >= (int)NullD.Common.MPQ.FileFormats.MarkerType.GizmoLocationA && (int)marker.Type <= (int)NullD.Common.MPQ.FileFormats.MarkerType.GizmoLocationZ)
                            {
