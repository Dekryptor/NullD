...
using NullD.Common.Helpers.Concurrency;
using NullD.Core.GS.Actors;
using NullD.Core.GS.Players;
using System.Collections.Generic;

namespace NullD.Core.GS.Map.Debug
{
    public class DebugNavMesh
    {
        ...
        private void AnalyzeScene(Scene scene)
        {
            Parallel.ForEach(scene.NavZone.NavCells, cell =>
            {
                ...
                if ((cell.Flags & NullD.Common.MPQ.FileFormats.Scene.NavCellFlags.AllowWalk) != NullD.Common.MPQ.FileFormats.Scene.NavCellFlags.AllowWalk)
