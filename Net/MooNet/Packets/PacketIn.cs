...
namespace NullD.Net.LogNet.Packets
{
    public class PacketIn
    {
        public LogNetClient Client { get; private set; }

        public bnet.protocol.Header Header { get; private set; }

        public PacketIn(LogNetClient client, bnet.protocol.Header header)
        {
            this.Client = client;
            this.Header = header;
        }
        ...
        {
            byte[] data = Client.IncomingLogNetStream.GetPacketData((int)this.Header.Size);
        ...
        {
            var data = Client.IncomingLogNetStream.GetPacketData((int)this.Header.Size);
            return data;
        }
