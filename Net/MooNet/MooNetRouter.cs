...
{
    public static class LogNetRouter
    {
        ...
        public static void Route(ConnectionDataEventArgs e)
        {
            ...
            client.IncomingLogNetStream.Append(e.Data.ToArray());

            try
            {
                while (client.IncomingLogNetStream.PacketAvaliable())
                {
                    Identify(client);
                }
            }
            ...
            client.IncomingLogNetStream.Consume();
        }
