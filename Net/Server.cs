...
namespace NullD.Net
{
    public class Server : IDisposable
    {
        ...
        public virtual bool Listen(string bindIP, int port)
        {
            ...
            // IPv6 only works for LogNet right now. When Blizzard fixes D3 client for so, we'll be also supporting IPv6 in game-server.
        ...
        private void ReceiveEncryptRequestServiceResponse(IConnection connection)
        {
            ...
            // However, this would require looking into the LogNetClient's RPCCallbacks for the token,
