...
namespace NullD.Net.GS.Message.Definitions.Encounter
{
    [Message(new[] { Opcodes.BossEncounterAccept }, Consumers.Player)]
    //[Message(new[] {Opcodes.BossEncounterMessage1, Opcodes.BossEncounterMessage2})]
    public class BossEncounterAccept : GameMessage
    {
        public int Field0;
