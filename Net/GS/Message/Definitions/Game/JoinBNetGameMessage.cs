...
namespace NullD.Net.GS.Message.Definitions.Game
{
    ...
    public class JoinBNetGameMessage : GameMessage
    {
        ...
        public int GameId; // and this is the SGameId there we set in NullD.Core.LogNet.Games.Game.cs when we send the connection info to client /raist.
        public long Field3;
        public int Field4;
